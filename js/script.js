...
function Player(thatMainGame)
{
    ...
    this.movePlayerUpward = function()
    {
        if (that.counterup <50)
        {
            ...
            that.playerY-=2;
            that.player.style.top = that.playerY + "px";
            document.getElementsByClassName("ScoreCount")[0].innerHTML = "SCORE : "+thatMainGame.score;
